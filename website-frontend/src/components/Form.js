    ...
    render() {
        ...
        return (
                ...
                <form id="formImgUpload" onSubmit={this.addImage} class=" bg-gray-600  max-w-screen-md mx-auto border border-yellow-100 shadow-lg rounded px-4 pt-2 pb-2 mb-4  flex flex-col my-6">
                    <div class=" tracking-wide text-white text-xl font-bold mx-auto mb-6">Upload a new photo </div>
                    <div class="-mx-3 md:flex mb-3">
                        <div class="md:w-1/2 px-3 mb-4 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-2 px-4 mb-3" id="inputImgTitle" name="inputImgTitle" value={inputImgTitle} onChange={this.handleChange} type="text" />
                        </div>
                        <div class="md:w-1/2 px-3">
                            <label class="block  tracking-wide text-yellow-100 text-xs font-bold mb-2" for="inputImgDesc">
                                Description (Optional)
                </label>
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-2 px-4" id="inputImgDesc" name="inputImgDesc" value={inputImgDesc} onChange={this.handleChange} type="text" />
                        </div>
                    </div>
                    <div class="-mx-3 md:flex mb-3">
                        <div class="md:w-full px-3">
                            ...
                            <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-2 px-4 mb-3" id="inputImgUrl" name="inputImgUrl" value={inputImgUrl} onChange={this.handleChange} type="text" />
